...
export default function Sprockets() {
  ...
  useEffect(() => {
    fetch("https://bearings-api-production-7b5d.up.railway.app/sprockets")
      .then((res) => res.json())
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        width: "100%",
        backgroundImage: "url('/images/sprockets-bg.png')",
    ...
    >
      ...
      >
        ...
        <h1 style={{ color: "white" }}>Sprockets</h1>

        <input
          type="text"
          placeholder="Search sprocket..."
          value={search}
